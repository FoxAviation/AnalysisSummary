...
\end{itemize}
  ...
  $
  	...
  	\sinh(x):=\frac{1}{2}(e^x-e^{-x})=\sum_{k=0}^{\infty}\frac{x^{2k+1}}{(2n+1)!} = x + \frac{x^3}{6} + \frac{x^5}{120} + \laO(x^7)\\
  	\cosh(x):=\frac{1}{2}(e^x+e^{-x})=\sum_{k=0}^{\infty}\frac{x^{2k}}{(2n)!} = 1 + \frac{x^2}{2} + \frac{x^4}{24} + \frac{x^6}{720} + \laO(x^7)\\
...
%TODO: Definitionsbereich einfügen
  ...
  \begin{itemize}
  \item $f$ stetig $\vee$ monoton $\Rightarrow f$ integrierbar
  ...
  \begin{itemize}
	...
	\section{Koordinatentransformation}
		...
		$
			...
			\quad dxdy \mapsto r \cdot \r drd\varphi
		$
