...
\section{Sonstiges}
        ...
        \begin{tabular}{ll}
	        Harmonische Reihe &  $\sum_{k=1}^{\infty}\frac{1}{k}=+\infty; \sum_{k=1}^{\infty}\frac{1}{k^a}$ divergiert f. $a \leq 1 $ , konvergiert für $a > 1$\vspace{2pt}\\\vspace{1pt}
