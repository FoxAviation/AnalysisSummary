		...
		\end{itemize}
			...
			\begin{tabular}{|c|c|c|c|c|c|}
				\hline
                          ...
                          $\sin$ &$\frac{\sqrt{0}}{2}=0$  &$\frac{\sqrt{1}}{2}=\frac{1}{2}$  &$\frac{\sqrt{2}}{2}=\frac{1}{\sqrt{2}}$  &$\frac{\sqrt{3}}{2}$              &$\frac{\sqrt{4}}{2}=1$\\ \hline
                          $\cos$ &$\frac{\sqrt{4}}{2}=1$  &$\frac{\sqrt{3}}{2}$              &$\frac{\sqrt{2}}{2}=\frac{1}{\sqrt{2}}$  &$\frac{\sqrt{1}}{2}=\frac{1}{2}$  &$\frac{\sqrt{0}}{2}=0$\\ \hline
			\end{tabular}
\end{multicols*}
\end{document}
%%% Local Variables:
