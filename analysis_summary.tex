...
%TODO: Definitionsbereich einfügen
  ...
  %TODO: Potenzreihen: n-ter Taylor = n-te Partialsumme
...
\section{Sonstiges}
        ...
        \begin{tabular}{ll}
	        ...
	        Logarithmusreihe & $\sum_{k=1}^{\infty}(-1)^{k+1}\frac{x^k}{k} = \ln(1+x)$\\
	        Arcus-Tangens-Reihe & $\sum_{k=0}^{\infty}(-1)^k\frac{x^{2k+1}}{2k+1} = \arctan(x)$ in $[-1,1]$\\
