  	...
  	\item $\overline{z} = x-iy$
        ...
        \begin{tabular}{|l|l|l|}
          \hline
           ...
           $\frac{1}{\sqrt{1-x^2}}$                             & $arcsin(x)$    & TODO                                   \\ \hline
           $-\frac{1}{\sqrt{1-x^2}}$                            & $arccos(x)$    &                                        \\ \hline
           $\frac{1}{x^2+1}$                                    & $arctan(x)$    &                                        \\ \hline
           $\frac{1}{\sqrt{x^2+1}}$                             & $arsinh(x)$    &                                        \\ \hline
           $\frac{1}{\sqrt{x-1}\sqrt{x+1}}$                     & $arcosh(x)$    &                                        \\ \hline
           $\frac{1}{1-x^2}$                                    & $artanh(x)$    &                                        \\ \hline
           $\frac{1}{cos^2(x)}$                                 & $tan(x)$       &                                        \\ \hline
           $\frac{1}{cosh^2(x)}$                                & $tanh(x)$      &                                        \\ \hline
