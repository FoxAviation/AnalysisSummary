...
\end{itemize}
  ...
  \paragraph{Potenzreihe}
    ...
    $\sum_{k=1}^{\infty}\frac{1}{k}=+\infty; \sum_{k=1}^{\infty}\frac{1}{k^a}=0 \ \forall a \geq 2;$

    \paragraph{Geometrische Reihe}

    $\sum_{k=1}^{\infty}a_0q^k=\frac{a_0}{1-q} \ \forall |q| < 1$
 ...
 \item Allg. Lsg.: $y(t)=y_h(t)+y_p(t)$
  ...
  \begin{itemize}
  	...
  	\item $\overline{z} = x-iy$
        ...
        \begin{tabular}{|l|l|l|}
          \hline
          $f(x)$         & $\frac{\mathrm d}{\mathrm d x} \left( f(x) \right)$  &  $\int \left( f(x) \right) \mathrm{d}x$ \\ \hline
          $arcsin(x)$    & $\frac{1}{\sqrt{1-x^2}}$                             &  TODO                                   \\ \hline
          $arccos(x)$    & $-\frac{1}{\sqrt{1-x^2}}$                            &                                         \\ \hline
          $arctan(x)$    & $\frac{1}{x^2+1}$                                    &                                         \\ \hline
          $arsinh(x)$    & $\frac{1}{\sqrt{x^2+1}}$                             &                                         \\ \hline
          $arcosh(x)$    & $\frac{1}{\sqrt{x-1}\sqrt{x+1}}$                     &                                         \\ \hline
          $artanh(x)$    & $\frac{1}{1-x^2}$                                    &                                         \\ \hline
          $tan(x)$       & $\frac{1}{cos^2(x)}$                                 &                                         \\ \hline
          $tanh(x)$      & $\frac{1}{cosh^2(x)}$                                &                                         \\ \hline
          $sin(x)cos(x)$ &                                                      & $-\frac{1}{2}cos^2(x)$                  \\ \hline
          $cos^2(x)$     &                                                      & $\frac{1}{2}(x+sin(x)cos(x))$           \\ \hline
          $sin^2(x)$     &                                                      & $\frac{1}{2}(x-sin(x)cos(x))$           \\ \hline
          $ln(x)$        & $\frac{1}{x}$                                        & $x \cdot ln(x)-x$                       \\ \hline
        \end{tabular}
